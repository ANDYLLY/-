...

{
...

  {
    ...
    case'\n':morse.dot();morse.dot();morse.dot();morse.dot();morse.dot();morse.dot();break;//换行代表******

    case' ':morse.dash();morse.dash();morse.dash();morse.dash();morse.dash();morse.dash();break;//空格代表------
